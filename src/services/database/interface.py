...
class IDateBase(ABC):
    ...
    @abstractmethod
    async def get_themes_by_condition(self, condition: dict) -> list[ThemeModel]:
    ...
    # --- Notes methods --- #
    @abstractmethod
    async def write_new_note(self, theme: NoteModel) -> str:
    ...
    @abstractmethod
    async def get_notes_by_condition(self, condition: dict) -> list[NoteModel]:
    ...
    @abstractmethod
    def delete_note_by_id(self, note: str) -> int:
        """Delete single note from db by id"""
        raise NotImplementedError

    @abstractmethod
    def delete_all_notes_by_condition(self, condition: dict) -> int:
